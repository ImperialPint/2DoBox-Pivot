...
/***/ function(module, exports, __webpack_require__) {
	...
	function countChar(input, output){
	     ...
	     if (length >= 121) {
	              input.value = input.val().substring(0, 121);
	     } else {
	              input.text(121 - length);
	     }
	     output.text(length);
	}
