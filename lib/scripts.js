...
$(document).ready(function(){
  ...
  toDoArray = AllToDos.filterComplete(toDoArray);
...
$('.complete-btn').on('click', function(){
  ...
  AllToDos.clearListContainer();
  AllToDos.renderStorage();
  var toDoArrayz = AllToDos.retrieve();
  toDoArray = AllToDos.filterIncomplete(toDoArrayz);
  AllToDos.renderStorage();
});
...
var AllToDos = {
  ...
  filterComplete: function() {
    this.toDoArray = this.toDoArray.filter(function (r) {
